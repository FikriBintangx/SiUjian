...
public class LoginDosenFrame extends JFrame {

    private final AuthData authRepository = new AuthData();
    private JTextField txtUsername; // reused as NIDN
    private JTextField txtName; // reused as Name
    private JLabel lblError;

    private final Color COL_PRIMARY = new Color(13, 148, 136);
    private final Color COL_BG_LEFT = new Color(240, 253, 250);
    private final String LOGO_PATH = "C:\\Users\\fikri\\Documents\\NetBeansProjects\\Appujian\\assets\\logo.png";

    public LoginDosenFrame() {
        setTitle("SiUjian - Login Dosen");
        setSize(1000, 650);
        ...
        try {
            ...
            lblLogo.setIcon(new IconGraduation(100, COL_PRIMARY));
            lblLogo.setText("");
        }
        ...
        JLabel lblDesc = new JLabel(
                "<html><center><font size='4'>Panel Dosen Pengawas<br><font size='3'>Pantau dan kelola integritas ujian</font></center></html>",
                SwingConstants.CENTER);
        lblDesc.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        lblDesc.setForeground(new Color(15, 118, 110));
        ...
        JLabel lblTitle = new JLabel("Login Dosen");
        ...
        JLabel lblSub = new JLabel("Masuk untuk mengelola sesi ujian dan monitoring");
        ...
        JLabel lblUserTitle = new JLabel("NIDN (Nomor Induk Dosen)");
        ...
        txtUsername.setToolTipText("Masukkan NIDN");
        rightPanel.add(txtUsername, gbc);

        gbc.insets = new Insets(0, 0, 8, 0);
        JLabel lblPassTitle = new JLabel("Nama Lengkap");
        ...
        txtName = createStyledField(); // Use Styled JTextField
        txtName.setToolTipText("Masukkan Nama Lengkap Sesuai Data");
        ...
        JButton btnLogin = createPrimaryButton("Masuk Dashboard Dosen");
    ...
    private void performLogin() {
        ...
        String p = txtName.getText().trim();

        if (u.isEmpty() || p.isEmpty()) {
            lblError.setText("[!] Lengkapi NIDN dan Nama.");
            return;
        }

        try {
            if (authRepository.loginLecturer(u, p)) {
                new id.ac.campus.antiexam.ui.ux.dosen.BerandaDosenFrame(u).setVisible(true);
                dispose();
            } else {
                lblError.setText("[!] NIDN atau Nama tidak ditemukan/salah.");
            }
        } catch (Exception ex) {
